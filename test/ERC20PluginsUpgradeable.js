...
describe('ERC20PluginsUpgradeable', function () {
    let wallet1;
    ...
    async function initContracts () {
        const ERC20PluginsUpgradeableMock = await ethers.getContractFactory('ERC20PluginsUpgradeableMock');
        const erc20Plugins = await ERC20PluginsUpgradeableMock.deploy();
        await erc20Plugins.waitForDeployment();
        await erc20Plugins.initialize('ERC20PluginsUpgradeableMock', 'EPM', PLUGIN_COUNT_LIMITS, PLUGIN_GAS_LIMIT);
